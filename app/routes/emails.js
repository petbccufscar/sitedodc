...
module.exports = {
	...
	/** Nova Notifications de email */
	'notificacao-mensagem': function (req, res, callback) {
		// To test enquiry notifications we create a dummy enquiry that
		// is not saved to the database, but passed to the template.

		var Mensagem = keystone.list('Mensagem');

		var novaMensagem = new Mensagem.model({
